# 🚀 TikTok数据分析与市场调研｜关键词搜索 · 博主作品 · 视频评论（无需登录 / 不封号）
...
> **前置（只需做一次）**：通过微信 `13395823479`（备注"TikTok 技能"）申请 Token，或到 [TikTok数据分析与市场调研SKILL](https://www.guaikei.com) 自助开通，然后配置环境变量：
>
> ```bash
> # Windows
...
- **开通**：微信 `13395823479`（备注"TikTok 技能"），或 [TikTok市场调研技能](https://www.guaikei.com) 自助开通。
