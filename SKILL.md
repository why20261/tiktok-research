...
description: 通过怪奇信息查询和分析TikTok视频、达人、评论和品类机会研究。用户提到TikTok或海外版抖音 数据分析、市场调研、选品、找品、爆品、趋势、市场容量、竞争结构等数据形成经营判断时使用，依据TikTok真实返回的数据形成分析结论。当用户任务需要的数据有TikTok视频、抓博主作品、看TikTok评论、做市场调研分析、做竞品/对标账号监控、短视频选题调研、评论舆情分析、热点追踪、爆款挖掘时使用。触发词：TikTok搜索、TikTok评论、TikTok作品、博主作品、市场调研、对标账号、TikTok竞品分析、TikTok数据分析、短视频运营、TikTok舆情监控、热点追踪、爆款挖掘、tiktok search、tiktok work、douyin comments。
license: MIT
version: 1.0.0
metadata:
  enabled: true
  ...
  requires:
    ...
    env:
      - "GUAIKEI_API_TOKEN"
  env_desc:
    GUAIKEI_API_TOKEN: "TikTok 数据 API 访问令牌（长度 16-256，仅含字母、数字、下划线、连字符）。可通过 www.guaikei.com 自助开通，或联系开发者微信 13395823479（备注：TikTok技能）获取支持。"
  category:
    - "Data&APIs"
    - "内容创作"
    - "数据分析"
...
> 💡**一句话价值**：一个口语化指令拿到TikTok公开的视频/作者/评论数据，直接输出结构化JSON——做数据分析、市场调研、爆款选题、对标账号监控、评论舆情分析、热点追踪，不用再手动刷TikTok。
...
- 官网：[TikTok数据分析与市场调研技能](https://www.guaikei.com)（自助开通 Token、查阅用量与接口说明）。
